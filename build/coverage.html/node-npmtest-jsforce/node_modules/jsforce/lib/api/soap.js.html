...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsforce/node_modules/jsforce/lib/api/soap.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsforce/node_modules/jsforce/lib/api/soap.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsforce/node_modules/jsforce/lib/api/</a> &#187; soap.js</div>
</div>
<div class="body">
 ...
 */
var SoapApi = module.exports = <span class="fstat-no" title="function not covered" >function(conn) {</span>
 ...
 * @private
 */
SoapApi.prototype._invoke = <span class="fstat-no" title="function not covered" >function(method, message, schema, callback) {</span>
...
<span class="cstat-no" title="statement not covered" >  return soapEndpoint.invoke(method, message, { result: schema }).then(<span class="fstat-no" title="function not covered" >function(res) {</span></span>
 ...
 */
SoapApi.prototype.convertLead = <span class="fstat-no" title="function not covered" >function(leadConverts, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var schema = _.isArray(leadConverts) ? [ Schemas.LeadConvertResult ] : Schemas.LeadConvertResult;</span>
<span class="cstat-no" title="statement not covered" >  return this._invoke("convertLead", { leadConverts: leadConverts }, schema, callback);</span>
};
 ...
 */
SoapApi.prototype.merge = <span class="fstat-no" title="function not covered" >function(mergeRequests, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var schema = _.isArray(mergeRequests) ? [ Schemas.MergeResult ] : Schemas.MergeResult;</span>
<span class="cstat-no" title="statement not covered" >  return this._invoke("merge", { mergeRequests: mergeRequests }, schema, callback);</span>
};
Schemas.MergeResult = {
  success: 'boolean',
  errors: [],
 ...
 */
SoapApi.prototype.emptyRecycleBin = <span class="fstat-no" title="function not covered" >function(ids, callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._invoke("emptyRecycleBin", { ids: ids }, [ Schemas.EmptyRecycleBinResult ], callback);</span>
};
 ...
 */
SoapApi.prototype.describeTabs = <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._invoke("describeTabs", {}, [ Schemas.DescribeTabSetResult ], callback);</span>
};
 ...
 */
SoapApi.prototype.getServerTimestamp = <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._invoke("getServerTimestamp", {}, Schemas.GetServerTimestampResult, callback);</span>
};
 ...
 */
SoapApi.prototype.getUserInfo = <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._invoke("getUserInfo", {}, Schemas.GetUserInfoResult, callback);</span>
};
 ...
 */
SoapApi.prototype.setPassword = <span class="fstat-no" title="function not covered" >function(userId, password, callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._invoke("setPassword", { userId: userId, password: password }, callback);</span>
};
&nbsp;
/**
 ...
 */
SoapApi.prototype.resetPassword = <span class="fstat-no" title="function not covered" >function(userId, callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._invoke("resetPassword", { userId: userId }, callback);</span>
};
&nbsp;
&nbsp;
/*--------------------------------------------*/
...
<span class="cstat-no" title="statement not covered" >  conn.soap = new SoapApi(conn);</span>
});
&nbsp;
&nbsp;

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsforce/node_modules/jsforce/lib/process.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsforce/node_modules/jsforce/lib/process.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsforce/node_modules/jsforce/lib/</a> &#187; process.js</div>
</div>
<div class="body">
 ...
 */
var Process = module.exports = <span class="fstat-no" title="function not covered" >function(conn) {</span>
  /**
   * Object which mangages process rules
   * @member {Process~ProcessRule} Process#rule
   */
<span class="cstat-no" title="statement not covered" >  this.rule = new ProcessRule(conn);</span>
  /**
   * Object which mangages approval process
   * @member {Process~ApprovalProcess} Process#approval
   */
<span class="cstat-no" title="statement not covered" >  this.approval = new ApprovalProcess(conn);</span>
};
&nbsp;
/**
 ...
 * @param {Connection} conn - Connection object
 */
var ProcessRule = <span class="fstat-no" title="function not covered" >function(conn) {</span>
 ...
 */
ProcessRule.prototype.list = <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._conn.request("/process/rules").then(<span class="fstat-no" title="function not covered" >function(res) {</span></span>
<span class="cstat-no" title="statement not covered" >    return res.rules;</span>
  }).thenCall(callback);
};
&nbsp;
&nbsp;
 ...
 */
ProcessRule.prototype.trigger = <span class="fstat-no" title="function not covered" >function(contextIds, callback) {</span>
<span class="cstat-no" title="statement not covered" >  contextIds = _.isArray(contextIds) ? contextIds : [ contextIds ];</span>
<span class="cstat-no" title="statement not covered" >  return this._conn.request({</span>
    method: "POST",
    url: "/process/rules/",
    body: JSON.stringify({
 ...
 * @param {Connection} conn - Connection object
 */
var ApprovalProcess = <span class="fstat-no" title="function not covered" >function(conn) {</span>
<span class="cstat-no" title="statement not covered" >  this._conn = conn;</span>
};
&nbsp;
/**
 ...
 */
ApprovalProcess.prototype.list = <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._conn.request("/process/approvals").then(<span class="fstat-no" title="function not covered" >function(res) {</span></span>
<span class="cstat-no" title="statement not covered" >    return res.approvals;</span>
  }).thenCall(callback);
};
&nbsp;
/**
 ...
 */
ApprovalProcess.prototype.request = <span class="fstat-no" title="function not covered" >function(requests, callback) {</span>
<span class="cstat-no" title="statement not covered" >  requests = requests.map(<span class="fstat-no" title="function not covered" >function(req) {</span></span>
<span class="cstat-no" title="statement not covered" >    return req._request ? req._request : req;</span>
  });
<span class="cstat-no" title="statement not covered" >  return this._conn.request({</span>
    method: 'POST',
 ...
 * @private
 */
ApprovalProcess.prototype._createRequest = <span class="fstat-no" title="function not covered" >function(actionType, contextId, comments, options, callback) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof comments === "function") {</span>
<span class="cstat-no" title="statement not covered" >    callback = comments;</span>
<span class="cstat-no" title="statement not covered" >    options = null;</span>
<span class="cstat-no" title="statement not covered" >    comments = null;</span>
  }
...
<span class="cstat-no" title="statement not covered" >  _.extend(request, options);</span>
<span class="cstat-no" title="statement not covered" >  return new ApprovalProcessRequest(this, request).thenCall(callback);</span>
};
&nbsp;
/**
 ...
 */
ApprovalProcess.prototype.submit = <span class="fstat-no" title="function not covered" >function(contextId, comments, options, callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._createRequest("Submit", contextId, comments, options, callback);</span>
};
&nbsp;
/**
 ...
 * @returns {ApprovalProcessRequest}
 */
ApprovalProcess.prototype.approve = <span class="fstat-no" title="function not covered" >function(workitemId, comments, options, callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._createRequest("Approve", workitemId, comments, options, callback);</span>
};
&nbsp;
/**
 ...
 * @returns {ApprovalProcessRequest}
 */
ApprovalProcess.prototype.reject = <span class="fstat-no" title="function not covered" >function(workitemId, comments, options, callback) {</span>
<span class="cstat-no" title="statement not covered" >  return this._createRequest("Reject", workitemId, comments, options, callback);</span>
};
&nbsp;
/**
 ...
 */
var ApprovalProcessRequest = <span class="fstat-no" title="function not covered" >function(process, request) {</span>
 ...
 */
ApprovalProcessRequest.prototype.then = <span class="fstat-no" title="function not covered" >function(onResolve, onReject) {</span>
<span class="cstat-no" title="statement not covered" >  if (!this._promise) {</span>
<span class="cstat-no" title="statement not covered" >    this._promise = this._process.request([ this ]).then(<span class="fstat-no" title="function not covered" >function(rets) {</span></span>
<span class="cstat-no" title="statement not covered" >      return rets[0];</span>
    });
  }
<span class="cstat-no" title="statement not covered" >  this._promise.then(onResolve, onReject);</span>
};
&nbsp;
/**
 * Promise/A+ extension
 ...
 */
ApprovalProcessRequest.prototype.thenCall = <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >  return callback ? this.then(<span class="fstat-no" title="function not covered" >function(res) {</span></span>
